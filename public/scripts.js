...
// Eliminamos la redeclaración de currentLang, que ya está en lang.js
// let currentLang = 'es'; 
...
// Verificar que translations exista (mantenemos esta parte para compatibilidad)
if (typeof translations === 'undefined') {
  console.warn('⚠️ Variable translations no encontrada. Se intentará cargar desde lang.js');
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('.lang-flag').forEach(flag => {
    flag.addEventListener('click', function() {
      ...
      if (lang) {
        // Usamos setLang que ya está definido en lang.js
        setLang(lang);
      }
    });
  });
  ...
  pixForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Usamos renderQRContent que está definido en lang.js
